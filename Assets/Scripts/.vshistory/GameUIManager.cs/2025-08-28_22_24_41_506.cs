...
public class GameUIManager : MonoBehaviour
{
    ...
    private Vector2[] badgeOriginalPositions;
    ...
    public void ShowStartUI()
    {
        ...
        badgeOriginalPositions = new Vector2[childCount];
        for (int i = 0; i < childCount; i++)
            badgeOriginalPositions[i] = powerupBadgesParent.GetChild(i).GetComponent<RectTransform>().anchoredPosition;
    ...
    public void ResetPowerupBadges()
    {
        ...
        for (int i = 0; i < childCount; i++)
        {
            ...
            child.DOKill();
            child.anchoredPosition = badgeOriginalPositions[i]; // restores properly with anchors
        }
    }
}
