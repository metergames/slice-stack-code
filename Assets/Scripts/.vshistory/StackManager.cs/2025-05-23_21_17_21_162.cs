...
public class StackManager : MonoBehaviour
{
    ...
    {
        GameObject fx = Instantiate(perfectEffectPrefab, block.position, Quaternion.identity);
        fx.transform.localScale = block.localScale * 1.05f; // match block size slightly bigger
        fx.GetComponent<PerfectEffect>().Play();
    }
}
