...
public class ShopItemEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        string headerText = "Confirmation Prompt";
        if (!string.IsNullOrEmpty(currentConfirmName))
        {
            headerText += $" (for '{currentConfirmName}')";
        }
        EditorGUILayout.LabelField(headerText, EditorStyles.boldLabel);
        // You can keep the Tooltip here for the field itself if you want
        EditorGUILayout.PropertyField(confirmNameProp, new GUIContent("Confirm Name", "Used to complete: 'Are you sure you would like to purchase {this}?'"));
