...
public class ShopItemEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            fullPromptPreview = "The purchase prompt will be: 'Are you sure you would like to purchase {an item}?'";
            EditorGUILayout.HelpBox(fullPromptPreview, MessageType.Info);
        }
        else
        {
            fullPromptPreview = $"The purchase prompt will be: 'Are you sure you would like to purchase {currentConfirmName}?'";
            EditorGUILayout.HelpBox(fullPromptPreview, MessageType.Info);
        }
