...
public class ShopItemEditor : Editor
{
    ...
    private SerializedProperty backgroundGroupProp;
    ...
    private void OnEnable()
    {
        ...
        backgroundGroupProp = serializedObject.FindProperty("backgroundGroup");
    ...
    public override void OnInspectorGUI()
    {
        ...
        // Conditional display for 'title' and 'audioClip' if category == Music
        ...
        // Conditional display for 'ownedCount' if category == Extras
        ...
        // Conditional display for 'skinMaterial' if category == Skins
        if (currentCategory == ShopCategory.Skins)
        {
        ...
        {
            EditorGUILayout.PropertyField(backgroundGroupProp, new GUIContent("Background Group"));
