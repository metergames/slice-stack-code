...
public class PowerupsManager : MonoBehaviour
{
    ...
    [SerializeField] private Color selectedColor = new Color32(112, 213, 83, 255); // green
    [SerializeField] private Color unselectedColor = new Color32(213, 200, 83, 255); // yellow
