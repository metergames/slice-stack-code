...
public class PowerupsManager : MonoBehaviour
{
    ...
    public void TogglePowerups()
    {
        ...
        shopButton.GetComponent<Button>().interactable = !shopButton.GetComponent<Button>().interactable;
        powerupsButton.GetComponent<Button>().interactable = !powerupsButton.GetComponent<Button>().interactable;
