...
public class MissionUI : MonoBehaviour
{
    ...
    private const float PROGRESS_BAR_MIN_RIGHT = 642f;
        ...
        if (claimButton != null)
        {
            ...
            if (claimButtonText != null)
            {
                ...
                if (isReadyToClaim)
                    ...
                    claimButtonText.text = $"<size=145%><color=#629BF7><voffset=-3px><sprite=0 tint=1></voffset></color></size>{mission.RewardAmount}<color=#00000000>-</color>";
            }
        }
